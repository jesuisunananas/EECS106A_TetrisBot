...
# moveit code from https://github.com/moveit/moveit2_tutorials/blob/main/doc/examples/motion_planning_python_api/scripts/motion_planning_python_api_planning_scene.py

# class CollisionPlanningNode(Node):
#     def __init__(self):
